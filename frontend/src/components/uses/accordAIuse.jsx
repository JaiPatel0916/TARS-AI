...
const cards = [
  {
    ...
    icon: Cpu,
    description:
      "Optimize production workflows with automated document handling for quality control, maintenance records, and supply chain integration.",
    pairWith: 2,
  },
  {
    id: 2,
    ...
    icon: Activity,
    description:
      "Manage permits, inspection reports, and regulatory paperwork to improve compliance and operational uptime.",
    pairWith: 1,
  },
  {
    id: 3,
    ...
    icon: ShieldCheck,
    description:
      "Automate invoice processing, reconciliations, and audit trails to reduce errors and accelerate financial close.",
    pairWith: 4,
  },
  {
    id: 4,
    ...
    icon: Users,
    description:
      "Streamline patient intake forms, billing documents, and clinical records securely to improve care delivery.",
    pairWith: 3,
  },
];

export default function AccordUse() {
