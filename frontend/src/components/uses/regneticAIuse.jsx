...
const cards = [
  ...
  },
  {
    ...
    icon: Users,
    description:
      "Automate employee records, onboarding paperwork, and compliance workflows to improve HR efficiency and accuracy.",
    pairWith: 3,
  },
];

export default function ragneticAIuse() {
