...
const timelineData = [
  {
    ...
    date: "Animation",
    content: "Facial animations perfectly match speech for realism.",
    category: "animation",
    icon: Video,
    relatedIds: [2, 3],
    status: "completed",
  ...
  },
  {
    ...
    title: "Voice AI",
    date: "Conversational",
    content: "Conversational automation with natural language & emotions.",
    category: "voice",
    icon: Mic,
    relatedIds: [1, 3, 5],
    status: "completed",
  ...
  },
  {
    ...
    date: "Engagement",
    content: "Reacts with expressive gestures & tone to build trust.",
    category: "emotion",
    icon: Smile,
    relatedIds: [1, 2, 5],
    status: "completed",
  ...
  },
  {
    ...
    date: "Deploy",
    content: "Deploy to websites, kiosks, mobile & immersive VR.",
    category: "platform",
    icon: Monitor,
    relatedIds: [5],
    status: "completed",
  ...
  {
    id: 5,
    title: "Smart Interaction Engine",
    date: "Intelligence",
    content: "Understands intent & guides users intelligently.",
...
export default function virtualbotCap() {
