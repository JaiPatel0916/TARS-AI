...
const timelineData = [
  {
    ...
    date: "AI Forecast",
    content: "AI-powered forecasting for demand, assets, and operational efficiency.",
    category: "analytics",
    icon: Brain,
    relatedIds: [2, 3],
    status: "completed",
  ...
  },
  {
    ...
    date: "Automation",
    content: "Automates approvals, workflows, and energy optimization.",
    category: "decision",
    icon: Cpu,
    relatedIds: [1, 3, 4],
    status: "completed",
  ...
  },
  {
    ...
    date: "Live Monitoring",
    content: "Unified dashboards for live monitoring of enterprise processes.",
  ...
  {
    id: 4,
    title: "LLM Conversational Control",
    date: "Natural Language",
    content: "Execute actions through natural language instructions.",
  ...
  },
  {
    ...
    date: "Zero-Trust",
    content: "Zero-trust protection, encryption, and policy compliance.",
    category: "security",
    icon: ShieldCheck,
    relatedIds: [3, 4],
    status: "completed",
...
export default function accordCap() {
