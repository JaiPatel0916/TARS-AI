...
const IndustriesSection = () => {
    ...
    return (
        <section
            className={`w-full px-4 md:px-8 py-24 overflow-hidden transition-colors duration-500
        ${theme === "dark"
                    ? "bg-gradient-to-r from-purple-1000 via-[#220e3b] to-purple-1000 text-white"
      ...
      `}
        >
            ...
            <div className="text-center mb-12">
                ...
                <p
                    className={`mt-3 ${theme === "dark" ? "text-white/60" : "text-gray-500"
                        }`}
                >
            ...
            <div className="relative w-full">
                ...
                min-w-[220px] sm:min-w-[260px] lg:min-w-[300px] xl:min-w-[320px]
                ...
                transition-transform duration-500 ease-out"
                            ...
                            onMouseLeave={(e) =>
                            (e.currentTarget.style.transform =
                                "perspective(1000px) rotateY(18deg)")
                            }
                        >
                            {/* Image */}
                            <img
